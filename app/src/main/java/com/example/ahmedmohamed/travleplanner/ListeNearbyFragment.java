...
public class ListeNearbyFragment extends Fragment {
    ...
    private  void  getdata(Double longi,Double lati){
        ...
        String url = "https://api.foursquare.com/v2/venues/explore?ll=" + lati + "," + longi + "&client_id=TMUWUAED1DRG0VIIUQJWQ3X1XQ4TA3JJDUZBIINXRVNKEOPV&client_secret=0AHQCKHLHFSU15JEYOUKW1EBLGMGM02PRTWZ0HA2MT1GH5LG&v=" + currentDateandTime;
